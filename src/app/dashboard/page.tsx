    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="w-64 bg-gray-50 border-r border-gray-200 flex flex-col overflow-y-auto">
          <div className="p-4">
            <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Accounts</p>
          ...
          {projects.length > 0 && (
            <div className="px-4 pb-4 flex-1 overflow-y-auto border-t border-gray-200 pt-4">
        ...
        <main className="flex-1 p-6 overflow-y-auto bg-white">
          ...
          {!selectedProject ? (
            <div className="flex flex-col items-center justify-center h-full text-center">
              <div className="rounded-2xl bg-gray-50 border border-gray-100 p-10 max-w-sm">
                ...
                <p className="text-sm font-medium text-gray-600 mb-1">No project selected</p>
                <p className="text-xs text-gray-400">Choose an account and project from the sidebar to browse your models.</p>
              </div>
            </div>
          ) : (
            <>
              ...
              <nav className="flex items-center gap-1 text-sm mb-5 flex-wrap">
                ...
                <span className="text-gray-500 font-medium">{selectedProject.name}</span>
              ...
              {loading ? (
                <div className="flex items-center gap-2.5 text-gray-400 text-sm py-8">
                ...
                <div className="rounded-xl border border-gray-200 overflow-hidden">
                  {items.length === 0 ? (
                    ...
                    <div key={item.id} className="flex items-center gap-3 px-4 py-3 border-b border-gray-100 last:border-0 hover:bg-gray-50 transition-colors">
                      ...
                      {item.type === "File" && !item.modelUrn && (
                        <span className="text-xs text-gray-300 shrink-0 italic">No URN</span>
                      )}
                    </div>
                  ))}
                </div>
